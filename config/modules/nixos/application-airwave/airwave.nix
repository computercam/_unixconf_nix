{ stdenv, multiStdenv, cmake, fetchFromGitHub, fetchurl, file, libX11
...
let
  ...
  # airwave-src = stdenv.mkDerivation {
  #   name = "airwave-src${version}";
  #   src = ./source;
  ...
  #   name = "vstsdk3613_08_04_2019_build_81";
  #   src = fetchurl {
  #     url = "https://download.steinberg.net/sdk_downloads/${name}.zip";
  #     sha256 = "756beeb261b36402a8fccd904313bfaff33a20651a7654f08fdf09bb7d6b2452";
  #   };
  #   nativeBuildInputs = [ unzip ];
  #   installPhase = "cp -r . $out";
  # };
  ...
  vst-sdk = stdenv.mkDerivation rec {
    name = "vstsdk3613_08_04_2019_build_81";
    src = ./vstsdk3613_08_04_2019_build_81.zip;
    nativeBuildInputs = [ unzip ];
    installPhase = "cp -r . $out";
  };
  ...
  # Uncomment below to test without waiting for xembed patch compliation 
  # wine-xembed = wine-wow64;
...
in multiStdenv.mkDerivation {
  ...
  postInstall = ''
    ...
    wrapProgram $out/bin/airwave-manager --prefix QT_PLUGIN_PATH : ${qt5.qtbase}/${qt5.qtbase.qtPluginPrefix}
